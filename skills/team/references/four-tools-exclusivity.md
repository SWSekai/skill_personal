...
Consultation / planning / troubleshooting conversations **with 3 rounds of back-and-forth without convergence** → auto-create `.hanschen/board/YYMMDD_<topic>_board.md`. 1-2 rounds with quick convergence → do not open whiteboard.
