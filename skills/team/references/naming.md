...
| 類型 | 目錄 | 檔名格式 | 範例 |
|---|---|---|---|
| whiteboard | `.hanschen/board/` | `YYMMDD_<topic>_board.md` | `260422_auth_refactor_board.md` |
| decision | `.hanschen/decision/` | `YYMMDD_<topic>_decision.md` | `260422_team_followup_decision.md` |
| ~~summary~~ | ~~`.local/docs/summary/`~~ | ~~`YYMMDD_<topic>_summary.md`~~ | ⚠️ 廢棄（2026-04-22）結案摘要改 append 於 CLOSED_ 原檔末尾（見 §5） |
| handoff | `.hanschen/handoff/` | `YYMMDD_handoff.md` | `260422_handoff.md` |
...
| §3.1 | §3.1.b | **原選 §3.1.a → 實作 §3.1.b，因 <reason>**（偏離示例，由 SKILL §C Step 6.0 偏離比對產出） |
...
4. 更新 `.hanschen/journal/PROJECT_JOURNAL.md`：
