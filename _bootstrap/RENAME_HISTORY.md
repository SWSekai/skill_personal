...
| 2026-05-08 | `.hanschen/docs/{board,decision,living,guides,handoff}/` | `.hanschen/{board,decision,journal,guides,handoff}/`（移除 `docs/` 中介層；`living` → `journal`）| 全域路徑扁平化 | `team/{SKILL,README}.md`、references/{naming,followup,daily-report,four-tools-exclusivity}.md、`hello/{SKILL,README}.md`、`skm/SKILL.md`、`build/SKILL.md`、`commit-push/{SKILL,README}.md`、`commit-push/references/meta-flag.md`、`memo/feedback_document_lessons.md`、`docs/file-output-reference.md`、`_bootstrap/templates/CLAUDE.md.template`、`manifest.json`、CLAUDE.md、`.hanschen/.history/README.md`；同步搬移 `.hanschen/docs/decision/*` (10 檔) → `.hanschen/decision/`、`.hanschen/docs/living/PROJECT_JOURNAL.md` → `.hanschen/journal/PROJECT_JOURNAL.md`、刪除 `.hanschen/docs/` 整個 shell | 2026-08-06 |
| 2026-05-08 | （無舊名）| `--no-subagent` flag 跨 skill 標準 | 新增 CLAUDE.md Rule 26；commit-push 既有實作為模板，新加入 build/team/skm 三 skill | `commit-push/SKILL.md`（新增 §--no-subagent）、`build/{SKILL,README}.md`、`team/{SKILL,README}.md`、`skm/{SKILL,README}.md`、CLAUDE.md Rule 26 | 2026-08-06 |
