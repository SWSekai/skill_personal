...
for candidate in \
    ...
    "$HOME/.claude/projects/D--<PROJECT_NAME>/memory" \
    "$HOME/.claude/projects/D--<APP_NAME>/memory" \
    "$USERPROFILE/.claude/projects/D--cm-wip_setup/memory" \
    "$USERPROFILE/.claude/projects/D--<PROJECT_NAME>/memory" \
    "$USERPROFILE/.claude/projects/D--<APP_NAME>/memory"; do
